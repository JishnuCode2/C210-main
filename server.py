...
def disconnectWithClient(message, client, client_name):
   ...
   if(entered_client_name in clients):
       ...
       greet_message = f"Hello, {entered_client_name}, you are successfully disconnected from {client_name} !"
       other_client_socket.send(greet_message.encode())

       msg = f"You are successfully disconnected from {entered_client_name} !"
